...
|---|---|---|---|---|
| 1 | **Phase 9 Live-Fire cadence** (start) | Operator-paced | 3-7d/flag wall-clock | Closes 🔴 vector #6; provides empirical baseline for Move 7+8 |
