...
| Parallel | Venom V1–V4, GitHub Patterns B+C | Pending |
...
8. Venom V1-V4 + GitHub Patterns B+C in parallel slots throughout
...
| 15 | Per-tool permissions (Venom V2) | §32.6 V2 | ~2 slices | pending |
