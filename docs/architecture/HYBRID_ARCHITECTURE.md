...
- [HYBRID_COST_OPTIMIZATION.md](../deployment/HYBRID_COST_OPTIMIZATION.md) - 94% cost reduction guide (Spot VMs, auto-cleanup)
- [README.md](./README.md) - Main project documentation and quick start guide
- [start_system.py](./start_system.py) - Hybrid system implementation code

### **Key Topics**
- **Cost Optimization**: See [HYBRID_COST_OPTIMIZATION.md](../deployment/HYBRID_COST_OPTIMIZATION.md) for details on $180/month → $11-15/month savings
