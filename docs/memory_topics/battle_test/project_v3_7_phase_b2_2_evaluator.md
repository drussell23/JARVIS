...
modules: [backend/core/ouroboros/governance/swe_bench_pro/evaluator.py, backend/core/ouroboros/governance/swe_bench_pro/__init__.py, tests/governance/test_swe_bench_pro_evaluator.py, backend/core/ouroboros/governance/intake/unified_intake_router.py, backend/core/ouroboros/governance/repair_engine.py, docs/architecture/OUROBOROS_VENOM_PRD.md]
status: historical
