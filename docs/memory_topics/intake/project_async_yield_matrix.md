...
modules: [backend/core/ouroboros/governance/candidate_generator.py, backend/core/ouroboros/governance/mutation_critical_section.py, backend/core/ouroboros/governance/operator_presence.py, backend/core/ouroboros/governance/operator_yield_bridge.py, docs/superpowers/plans/2026-06-21-sovereign-async-yield-matrix-plan.md, docs/superpowers/specs/2026-06-21-sovereign-async-yield-matrix-design.md]
status: historical
