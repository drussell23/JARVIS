...
modules: [backend/core/ouroboros/governance/change_engine.py, backend/core/ouroboros/governance/phase_runners/gate_runner.py, orchestrator.py, sandbox_exec.py, backend/core/ouroboros/governance/phase_runners/generate_runner.py, backend/core/ouroboros/governance/phase_runners/slice4b_runner.py, docs/superpowers/specs/2026-06-26-anti-venom-hardening-verified.md]
status: open
