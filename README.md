...
- **Battle Test Runner** — `scripts/ouroboros_battle_test.py` boots the full stack as a headless daemon with Consciousness, Venom, event spine, adaptive routing, and real API cost tracking ($0.50 default cap).
