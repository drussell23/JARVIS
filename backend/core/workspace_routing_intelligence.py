    ...
    def _initialize_patterns(self) -> None:
        ...
        self._patterns.append(IntentPattern(
            ...
            triggers=[
                ...
                # Category-aware triggers
                "check my promotions", "check promotions",
                "show promotions", "show my promotions",
                "what's in promotions", "what is in promotions",
                "check my social", "show social emails",
                "social emails", "social notifications",
                "what's in social", "what is in social",
                "check my updates", "show updates",
                "what's in my updates", "what is in my updates",
                "what's in updates", "what is in updates",
                "check forums", "show forums",
                "forum emails", "show my forums",
                "what's in forums", "what is in forums",
                "show my primary inbox", "check primary",
                "primary emails", "show primary emails",
                "what's in primary", "what is in primary",
            ],
            entity_patterns={
                "sender": r"from\s+([a-z]+(?:\s+[a-z]+)?)",
                "category": r"\b(primary|promotions?|social|updates?|forums?)\b",
            },
            visual_keywords=[],
            weight=0.8,
        ))
