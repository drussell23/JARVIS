...
def comparator_enabled() -> bool:
    ...
    schema live while disabling aggregation for a cost-cap rollback
    or empirical-question re-validation (hot-revert via ``export
    JARVIS_SBT_COMPARATOR_ENABLED=false``).
