...
def test_poll_interval_stays_default_when_webhook_flag_off(
    ...
    """Explicit flag=off preserves legacy pure-poll behavior.

    Graduated 2026-04-20 — default is now "true", so the test must
    explicitly set the flag off to exercise the opt-out path.
    """
...
def test_webhook_enabled_helper_reads_env_fresh(monkeypatch: Any) -> None:
    ...
    # Graduated 2026-04-20 — default is now "true" (webhook-primary).
